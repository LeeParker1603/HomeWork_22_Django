...
from .views import (
    ...
    ProductUpdateView,
    ProductDeleteView, ProductTogglePublishView, CategoryProductsListView
)
...
urlpatterns = [
    ...
    path('category/<int:pk>/', CategoryProductsListView.as_view(), name='category_products'), # Продукты по категориям
]
